...
namespace BreakTheCycle.CyberTaxi
{
    ...
    {
        [Header("Chunk Logic")]
        [SerializeField] private RecyclableChunkLogic _chunkLogicPrefab;
        ...
        public void RecycleChunk(RecyclableChunkLogic targetChunk)
        {
            targetChunk.RecyclableVisuals?.Recycle();
            targetChunk.Recycle();
        }
